...
let pdthds;
$(function() {
	$("#qunpdNewForm").submit(function(e) {
	...
	$("#qunpdNewForm").on('input', '#brandNomeIpt', function(e) {
		let keyword = $(this).val().replace(/(\s*$)/g, "").replace( /^\s*/, '').toUpperCase();
		brandNomeIptFunc(keyword)
	})
	...
	$("#qunpdNewForm").on('input', '#firNomeIpt', function(e) {
		let keyword = $(this).val().replace(/(\s*$)/g, "").replace( /^\s*/, '').toUpperCase();
		firNomeIptFunc(keyword)
	})
	...
	$("#qunpdNewForm").on('input', '#secNomeIpt', function(e) {
		let keyword = $(this).val().replace(/(\s*$)/g, "").replace( /^\s*/, '').toUpperCase();
		secNomeIptFunc(keyword)
	})
	...
	$("#qunpdNewForm").on('input', '#thdNomeIpt', function(e) {
		let keyword = $(this).val().replace(/(\s*$)/g, "").replace( /^\s*/, '').toUpperCase();
		thdNomeIptFunc(keyword)
	})
